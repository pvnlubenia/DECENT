...
%                                                                           %
%                                                                           %
% OUTPUT: Returns the nontrivial finest independent decomposition of a      %
%    chemical reaction network (CRN), if it exists. If no such              %
...
%    The output variables 'model', 'R', 'G', 'P', and 'results' allow the   %
...
function [model, R, G, P, results] = FID(model)
...
fprintf('\nFinest independent decomposition of %s:\n\n', model.id)
for i = 1:numel(P)
